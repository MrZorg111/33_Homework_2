...
«адача игрока Ч угадать сектор, в котором находитс€ рыба и, таким образом, поймать еЄ. 
≈сли игрок попал на пустой сектор, то удочку надо забросить повторно. ≈сли игрок поймал сапог, то игра завершаетс€ с отрицательным результатом.
...
после чего программа должна завершитьс€ и оповестить пользовател€ об успешной рыбалке и количестве попыток, которое ему дл€ этого потребовалось. 
≈сли же был пойман сапог, то должно выводитьс€ сообщение о неудачной ловле.
*/
